      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row gap-16 max-w-6xl mx-auto bg-white/6 rounded-3xl p-8 md:p-12 backdrop-blur-sm border border-white/10 shadow-2xl">
          ...
          <div className="w-full lg:w-2/3">
            <form className="space-y-6 bg-background rounded-2xl p-8 text-foreground shadow-lg">
              ...
              <button
                type="button"
                className="w-full py-4 bg-primary text-white font-semibold rounded-lg hover:bg-primary-dark transition-colors flex items-center justify-center gap-2 group"
              >
